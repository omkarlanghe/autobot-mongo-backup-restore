...
function dbAutoBackUp() {
    try {
        ...
        if (dbOptions.autoBackup == true) {
            ...
            let newBackupPath = `${dbOptions.autoBackupPath}\\dump`; // backup path for current backup process
            let writeable_stream = fs.createWriteStream(`${dbOptions.logFilePath}\\${dbOptions.logFileName}`).setDefaultEncoding('utf8');
